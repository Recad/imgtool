...
Mat MedianFilter::aplicarFiltroMediana(Mat image_src, int filterRows, int filterCols){
...
vector<int> MedianFilter::matToVector(Mat ventana){
    vector <int> vec;
    int pos = -1;
...
Mat MedianFilter::ventana(Mat image, int ventanitaRows, int ventanitaCols, int posX, int posY){
